          ...
          {t.services.items.map((service, index) => {
            ...
            return (
              <div key={index} className="group">
                <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 hover:border-blue-200 h-full hover:-translate-y-2 min-h-[420px]">
                  <div className="flex flex-col items-center text-center h-full">
                    <div className="w-18 h-18 bg-gradient-to-br from-blue-600 to-blue-700 rounded-full flex items-center justify-center mb-6 group-hover:scale-110 transition-all duration-300 shadow-lg">
                      <IconComponent className="w-9 h-9 text-white" />
                    </div>
                    <h3 className="text-lg font-bold text-gray-900 mb-4 leading-tight min-h-[4rem] flex items-center justify-center text-center">
                      <span className="break-words hyphens-auto">{service.title}</span>
                    </h3>
                    <p className="text-gray-600 flex-grow leading-relaxed text-sm mb-6 min-h-[4rem] flex items-center justify-center text-center">
